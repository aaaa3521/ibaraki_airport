...
export default function RoleSelect() {
  ...
  return (
    <div style={{ minHeight: '100svh', background: '#FDF6EC', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 16px', fontFamily: '"Noto Sans JP", sans-serif' }}>

      {/* Logo */}
      <img src={logo} alt="ロゴ" style={{ width: 160, marginBottom: 48, objectFit: 'contain' }} />
